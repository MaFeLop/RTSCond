...
{
    public class PagoServicio : IPagoService
    {
        public DataTable Listar(string periodo, int? condominioId, int pagina, int tamPagina)
        {
            var ds = DbExecutor.ExecuteDataSet("dbo.sp_UI_PagosPeriodo",
